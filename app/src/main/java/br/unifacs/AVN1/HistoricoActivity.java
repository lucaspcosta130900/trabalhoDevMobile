...
import br.unifacs.AVN1.databinding.ActivityHistoricoBinding;
...
public class HistoricoActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            ActivityCompat.requestPermissions(HistoricoActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
            return;
        }
        clickFPBtn();
    }
